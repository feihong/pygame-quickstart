...
def loop():
  """
  Edit anything in this function and the change will be reflected immediately in your program
  """
  global current_font, font
  ...
  draw_text(font, '☺😊Hello World! ❤️', (20, 60))

  draw_text(font, '你好世界！再见宇宙。', (20, 120))
